...
import { FriendLinkCard } from "@/features/friend-links/components/view/friend-link-card";
import { FriendLinkSkeleton } from "@/features/friend-links/components/view/friend-link-skeleton";
  ...
  if (links.length === 0) {
    return (
      <div className="py-20 text-center">
        <p className="font-serif text-lg text-muted-foreground/50">暂无友链</p>
...
function FriendLinksPage() {
  return (
    <div className="w-full max-w-3xl mx-auto pb-20 px-6 md:px-0">
      ...
      {/* Links Grid */}
      <Suspense fallback={<FriendLinksLoading />}>
        <FriendLinksList />
      </Suspense>
